...
public class Utility extends TestBase {
	...
	public static Map<String, Double> dayAndTemperatureMap = new LinkedHashMap<>();
	public static Map<String, String> dayAndWeatherMap = new LinkedHashMap<>();
	public static Map<String, Double> dayAndTemperatureFullMap = new LinkedHashMap<>();
	public static Map<String, String> dayAndWeatherFullMap = new LinkedHashMap<>();
...
//				+ " and longitude = " + properties.getProperty("longitude"));
		log.info("Printing below details for Sydney");
		log.info("\n");
		log.info("Day and Predicted Temperature of all upcoming 7 days in Sydney where current date is :"
	...
	public static void displayDayAndTempOfSelectedDays() {
		...
		if (size == 0) {
			...
			log.info("Above data confirms that there is no single day in Sydney in next 7 days where temperature is predicated to be above "
					+ properties.getProperty("predictedTemperature") + " degrees");
		} else {

			log.info("Number of days in Sydney which are predicted to be above " + properties.getProperty("predictedTemperature")
					+ " degrees are : " + count);
	...
	public static void displayDayAndWeatherOfAllDays() {
		...
		log.info("Day and Predicted Weather of all upcoming 7 days in Sydney where current date is :"
				+ convertToDate(stringCurrentDate));
...
//
//			log.info("Above data confirms that there is no single sunny day in Sydney in next 7 days");
//		} else {
//
//			String weatherType = properties.getProperty("predictedWeatherType");
//			if (weatherType.equalsIgnoreCase("Clear")) {
//
//				log.info("Number of predicted Sunny/Clear days in next 7 days in Sydney are : " + weatherDayCount);
//			} else if (weatherType.equalsIgnoreCase("Rain")) {
//
//				log.info("Number of predicted rainy days in next 7 days in Sydney are : " + weatherDayCount);
//			}
//
//			else if (weatherType.equalsIgnoreCase("Clouds")) {
//
//				log.info("Number of predicted cloudy days in next 7 days in Sydney are : " + weatherDayCount);
//			}
//
...
//	}
	...
	public static void displayDayAndWeatherOfSelectedDays() {
		...
		if (dayWeatherMapSize == 0) {
			...
			log.info("Above data confirms that there is no single rainy day in Sydney in next 7 days");
			}
			
			else if (weatherType.equalsIgnoreCase("Clouds"))
			{	
				
			log.info("Above data confirms that there is no single cloudy day in Sydney in next 7 days");
			}
